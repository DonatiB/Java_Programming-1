...
precargada, solicite al usuario un num entero y elimine la primer ocurrencia de num
...
public class P8_exercise5_2 {
  ...
  public static void main(String[] args) {
    ...
    try{
      ...
      delete_first_ocurrence(matint, num);
      print_matriz_int(matint);
    }
    catch(Exception exc){
  ...
  public static void delete_first_ocurrence(int[][] mat, int num){
    int row = 0;
    int col = MAXCOLUMN;
    ...
    if ((row < MAXROW) && (col < MAXCOLUMN)){
      ...
      System.out.println(num+" not found in the matriz");
    }
  }
